...
import myheros from "./images/me.png";

class Heros extends React.Component {
  render() {
    return (
      <section class="hero is-dark is-fullheight fullhero">
        <div class="hero-body">
          <div class="container">
            <section class="hero is-medium  myinfocard">
              <div class="myheroimg">
                <img class="myheroimgs" src={myheros}></img>
              </div>

              <div class="container pt-2 mt-2 pb-3 mb-4  ">
                <div class="flex">
                  <ul class="soc">
                    <li>
                ...
                <div class="container mycont ">
                  <h1 class="title is-size-1 is-primary is-size-3-mobile ">
                    HEY! THIS IS PRANIT PRAKASH
                  </h1>
                  <h2 class="subtitle is-size-2 is-danger is-size-4-mobile">
                    Full stack Developer and creative web designer
                  </h2>
                </div>
              </div>
            </section>
